...
import { selectAppointments, selectHastane, setAppointments } from "../../redux/slices/appSlice";
...
import AppointmentService from '../hastaneComponent/AppointmentService';

const DataTableCrudAppointments = () => {
    ...
    // ------------------------------------------------
    const storeAppointment = useSelector(selectAppointments)
    ...
    useEffect(() => {
        const getAllAppointment = async () => {
            const data = await AppointmentService.getAllAppointment();
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="New" disabled icon="pi pi-plus" className="p-button-success p-mr-2" onClick={openNew} />
    ...
    const header = (
        <div className="table-header">
            <h5 className="p-m-0">Manage Appointments</h5>
        ...
        return (
            <div className="datatable-crud-demo">
                ...
                <div className="card">
                    ...
                    <DataTable ref={dt} value={storeAppointment} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                        ...
                        <Column field="onlineDoktor.startDate" header="Appointment Date" sortable></Column>
                        <Column field="onlineDoktor.doktor.doktorName" header="Doctor Name" sortable></Column>
                        <Column field="onlineDoktor.doktor.departman.departmanName" header="Departman Name" sortable></Column>
                        <Column field="tcId" header="TC No" sortable></Column>
                        <Column field="telephoneNumber" header="TEL No" sortable></Column>
...
export default DataTableCrudAppointments;